# Manutenção assistida do portfólio

Este repositório contém o perfil público e o catálogo de projetos de Hendryl Harlacher.
...
Use português brasileiro por padrão e adapte `templates/README-PROJETO.md` ao projeto. Atualize os índices correspondentes e verifique os links. Não crie projetos fictícios apenas para preencher pastas.
